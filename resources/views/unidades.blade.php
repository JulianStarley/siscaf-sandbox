    ...
    <div class="container">
            ...
            <form id="formID" action="<?php echo url('farmaceutico/add'); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-offset-2">
                        <div class="form-group">
                            <label for="medicamento">Unidade <h11 style="color: red;">*</h11></label>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-offset-2">
                        <div class="form-group">
                            <label for="codigo">modulo <h11 style="color: red;">*</h11></label>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-offset-2">
                        <div class="form-group">
                            <label for="codigo">População Adstrita <h11 style="color: red;">*</h11></label>
                            <input type="text" required name="codigo" maxlength="20" class="form-control" value="">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-offset-2">
                            <div class="form-group">
                                <label for="codigo">Distancia CAF <h11 style="color: red;">*</h11></label>
                                <input type="text" required name="codigo" maxlength="20" class="form-control" value="">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-offset-2">
                            <div class="form-group">
                                <label for="codigo">Distancia de referencia do modulo <h11 style="color: red;">*</h11></label>
                                <input type="text" required name="codigo" maxlength="20" class="form-control" value="">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-offset-2">
                            <div class="form-group">
                                <label for="codigo">funcionarios responsaveis <h11 style="color: red;">*</h11></label>
                                <input type="text" required name="codigo" maxlength="20" class="form-control" value="">
